...
func PricePerUnit(v int) predicate.OrderItem {
...
func PricePerUnitEQ(v int) predicate.OrderItem {
	return predicate.OrderItem(sql.FieldEQ(FieldPricePerUnit, v))
}

// PricePerUnitNEQ applies the NEQ predicate on the "price_per_unit" field.
func PricePerUnitNEQ(v int) predicate.OrderItem {
...
func PricePerUnitIn(vs ...int) predicate.OrderItem {
...
func PricePerUnitNotIn(vs ...int) predicate.OrderItem {
...
func PricePerUnitGT(v int) predicate.OrderItem {
...
func PricePerUnitGTE(v int) predicate.OrderItem {
...
func PricePerUnitLT(v int) predicate.OrderItem {
...
func PricePerUnitLTE(v int) predicate.OrderItem {
...
func HasDeliveries() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasDeliveriesWith(preds ...predicate.Delivery) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
