...
func (cq *CustomerQuery) First(ctx context.Context) (*Customer, error) {
	nodes, err := cq.Limit(1).All(newQueryContext(ctx, TypeCustomer, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (cq *CustomerQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = cq.Limit(1).IDs(newQueryContext(ctx, TypeCustomer, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (cq *CustomerQuery) Only(ctx context.Context) (*Customer, error) {
	nodes, err := cq.Limit(2).All(newQueryContext(ctx, TypeCustomer, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (cq *CustomerQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = cq.Limit(2).IDs(newQueryContext(ctx, TypeCustomer, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (cq *CustomerQuery) All(ctx context.Context) ([]*Customer, error) {
	ctx = newQueryContext(ctx, TypeCustomer, "All")
	if err := cq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (cq *CustomerQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
	ctx = newQueryContext(ctx, TypeCustomer, "IDs")
...
func (cq *CustomerQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypeCustomer, "Count")
	if err := cq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (cq *CustomerQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypeCustomer, "Exist")
...
func (cgb *CustomerGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeCustomer, "GroupBy")
...
func (cs *CustomerSelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeCustomer, "Select")
