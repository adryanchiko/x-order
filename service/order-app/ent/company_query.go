...
func (cq *CompanyQuery) First(ctx context.Context) (*Company, error) {
	nodes, err := cq.Limit(1).All(newQueryContext(ctx, TypeCompany, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (cq *CompanyQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = cq.Limit(1).IDs(newQueryContext(ctx, TypeCompany, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (cq *CompanyQuery) Only(ctx context.Context) (*Company, error) {
	nodes, err := cq.Limit(2).All(newQueryContext(ctx, TypeCompany, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (cq *CompanyQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = cq.Limit(2).IDs(newQueryContext(ctx, TypeCompany, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (cq *CompanyQuery) All(ctx context.Context) ([]*Company, error) {
	ctx = newQueryContext(ctx, TypeCompany, "All")
	if err := cq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (cq *CompanyQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
	ctx = newQueryContext(ctx, TypeCompany, "IDs")
...
func (cq *CompanyQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypeCompany, "Count")
	if err := cq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (cq *CompanyQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypeCompany, "Exist")
...
func (cq *CompanyQuery) loadCustomers(ctx context.Context, query *CustomerQuery, nodes []*Company, init func(*Company), assign func(*Company, *Customer)) error {
	...
	query.Where(predicate.Customer(func(s *sql.Selector) {
		s.Where(sql.InValues(company.CustomersColumn, fks...))
	}))
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "company_customers" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (cgb *CompanyGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeCompany, "GroupBy")
...
func (cs *CompanySelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeCompany, "Select")
